...
void DrawTexture(Texture& t, const Vec4& rect, int flip = 0, int priority = 0);

TiledTexture ImportTiledTextureFromTexture(const Texture& t, int w, int h);
void DrawTile(TiledTexture& tt, int id, const Vec4& rect, int flip = 0, int priority = 0);
...
void DrawAnimation(FrameAnimation& fa, const Vec4& rect, int flip = 0, int priority = 0);
